...
const SalesOverviewChart = () => {
  ...
  return (
    <motion.div
      className="bg-white bg-opacity-80 dark:bg-gray-800 dark:bg-opacity-50 backdrop-blur-md shadow-lg rounded-xl p-6 border border-gray-700 mb-8 dark:border-gray-600"
    ...
    >
      <div className="flex items-center justify-between mb-6">
        ...
        <select
          className="bg-gray-200 text-black dark:bg-gray-700 dark:text-white rounded-md px-3 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500"
